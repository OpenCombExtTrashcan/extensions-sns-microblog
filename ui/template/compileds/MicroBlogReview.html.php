...
return \$__uivar_row->data('text');") ;?>  <a href="?c=microblog.MicroBlogReview&id=<?php echo eval("if(!isset(\$__uivar_row)){ \$__uivar_row=&\$aVariables->getRef('row') ;};
return \$__uivar_row->data('mbid');") ;?>&rid=<?php echo eval("if(!isset(\$__uivar_row)){ \$__uivar_row=&\$aVariables->getRef('row') ;};
return \$__uivar_row->data('rid');") ;?>">回复</a><br />
<?php 
					}
				}
			 		?>

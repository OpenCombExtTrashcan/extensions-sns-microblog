...
return \$__uivar_row->data('text');") ;?>  <a href="?c=microblog.delete&id=<?php echo eval("if(!isset(\$__uivar_row)){ \$__uivar_row=&\$aVariables->getRef('row') ;};
return \$__uivar_row->data('mbid');") ;?>">删除</a>   <a href="?c=microblog.forward&id=<?php echo eval("if(!isset(\$__uivar_row)){ \$__uivar_row=&\$aVariables->getRef('row') ;};
return \$__uivar_row->data('mbid');") ;?>">转发</a>    <a href="?c=microblog.review&id=<?php echo eval("if(!isset(\$__uivar_row)){ \$__uivar_row=&\$aVariables->getRef('row') ;};
...
return \$__uivar_forward->data('text');") ;?>  <a href="?c=microblog.forward&id=<?php echo eval("if(!isset(\$__uivar_forward)){ \$__uivar_forward=&\$aVariables->getRef('forward') ;};
return \$__uivar_forward->data('mbid');") ;?>">原文转发</a>    <a href="?c=microblog.review&id=<?php echo eval("if(!isset(\$__uivar_forward)){ \$__uivar_forward=&\$aVariables->getRef('forward') ;};
